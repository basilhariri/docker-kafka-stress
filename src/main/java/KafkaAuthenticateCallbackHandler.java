...
public class KafkaAuthenticateCallbackHandler implements AuthenticateCallbackHandler 
{
    ...
    OAuthBearerToken getOAuthBearerToken() throws InterruptedException, ExecutionException, TimeoutException, IOException, ParseException
    {
        ...
        return new KafkaOAuthBearerTokenImp(accesToken, claims.getExpirationTime());
    }
