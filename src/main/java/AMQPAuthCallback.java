...
class AMQPAuthCallback implements AzureActiveDirectoryTokenProvider.AuthenticationCallback {
    final private String clientId;
    final private String clientSecret;

    public AMQPAuthCallback(final String clientId, final String clientSecret) {
